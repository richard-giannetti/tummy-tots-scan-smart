...
export const BabyProfileDisplay = ({ babyProfile, onEdit, onAvatarUpdate }: BabyProfileDisplayProps) => {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <button
              ...
              className="relative mr-3 transition-transform hover:scale-105"
            >
              <Avatar className="w-12 h-12">
                {babyProfile.avatar_url ? (
                  <AvatarImage src={babyProfile.avatar_url} alt={babyProfile.name} />
                ) : (
